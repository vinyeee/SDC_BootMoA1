...
<div id="wrap">
	...
	<form method="post" action="/camp/bootcamp" >
			...
			<p>학원이름</p>
				<textarea  name= "bacademy" rows=7 cols=100% ></textarea><br>
			<p>학원 사이트</p>
				<textarea  name= "site" rows=7 cols=100% ></textarea><br>
			<p>학원주소</p>
				<textarea  name= "address" rows=7 cols=100% ></textarea><br>
				<div>
					<br>
					<input class="BtnReview" type="submit" value="부트캠프 등록하기">
				</div>	
			</article>
			</form>
		</section>
